...
namespace smERP.Persistence.Migrations
{
    ...
    [Migration("20241019150420_AddingNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("smERP.Application.Notifications.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("smERP.Domain.Entities.InventoryTransaction.AdjustmentTransaction", b =>
                {
                    ...
                    b.Property<bool>("IsTransactionProcessed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("smERP.Domain.Entities.InventoryTransaction.ProcurementTransaction", b =>
                {
                    ...
                    b.Property<decimal>("AmountLeftToPay")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("smERP.Persistence.Outbox.OutboxMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("smERP.Domain.Entities.Organization.Branch", b =>
                {
                    ...
                    b.OwnsMany("smERP.Domain.Entities.Organization.BranchProductInstanceAlertLevel", "BranchProductInstanceAlertLevels", b1 =>
                        {
                            b1.Property<int>("BranchId")
                                .HasColumnType("int");
                            ...
                            b1.Property<int>("AlertLevel")
                                .HasColumnType("int");

                            b1.HasKey("BranchId", "ProductInstanceId");

                            b1.HasIndex("ProductInstanceId");

                            b1.ToTable("BranchProductInstanceAlertLevel");
                    ...
                    b.Navigation("BranchProductInstanceAlertLevels");
            ...
            modelBuilder.Entity("smERP.Domain.Entities.User.Employee", b =>
                {
                    ...
                    b.OwnsOne("smERP.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                    ...
                    b.OwnsMany("smERP.Domain.ValueObjects.PhoneNumber", "PhoneNumbers", b1 =>
                        {
                            b1.Property<string>("EmployeeId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.ToTable("EmployeePhoneNumbers", (string)null);
