...
namespace smERP.Persistence.Migrations
{
    ...
    [Migration("20240929003107_AddingInventoryTransactions")]
    partial class AddingInventoryTransactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("smERP.Domain.Entities.InventoryTransaction.AdjustmentTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 0, 31, 7, 73, DateTimeKind.Utc).AddTicks(5851));
            ...
            modelBuilder.Entity("smERP.Domain.Entities.InventoryTransaction.ProcurementTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 0, 31, 7, 79, DateTimeKind.Utc).AddTicks(6691));
            ...
            modelBuilder.Entity("smERP.Domain.Entities.InventoryTransaction.SalesTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("TransactionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 0, 31, 7, 90, DateTimeKind.Utc).AddTicks(7910));
                    ...
                    b.OwnsMany("smERP.Domain.Entities.InventoryTransaction.TransactionPayment", "Payments", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("PaymentDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2024, 9, 29, 0, 31, 7, 89, DateTimeKind.Utc).AddTicks(4847));
                    ...
                    b.OwnsMany("smERP.Domain.Entities.InventoryTransaction.TransactionPayment", "Payments", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("PaymentDate")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("datetime2")
                                .HasDefaultValue(new DateTime(2024, 9, 29, 0, 31, 7, 99, DateTimeKind.Utc).AddTicks(9173));
