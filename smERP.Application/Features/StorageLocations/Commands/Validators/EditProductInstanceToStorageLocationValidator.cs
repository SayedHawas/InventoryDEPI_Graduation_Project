...
public class EditProductInstanceToStorageLocationValidator : AbstractValidator<EditProductInstanceToStorageLocationModel>
{
    public EditProductInstanceToStorageLocationValidator()
    {
